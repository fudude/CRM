...
import com.dude.crm.workbench.dao.*;
import com.dude.crm.workbench.domain.*;
...
public class ClueServiceImpl implements ClueService {
    ...
    public boolean convert(String clueId, Tran t, String createBy) {
        ...
        //经过第二步处理后，客户的信息我们已经拥有了，将来在处理其他表的时候，如果要使用到客户的id，直接使用cus.getId()就可以了
        ...
        * */
        ...
        for (ClueActivityRelation clueActivityRelation : clueActivityRelationList){
            ...
            //创建 联系人与市场活动的关联关系的对象让第三步生成的联系人与市场活动做关联
        ...
        if (t!=null){
            ...
            *   id,money,name,expectedDate,stage,acticityId,createBy,createTime
            *
