...
import com.dude.crm.workbench.dao.TranDao;
import com.dude.crm.workbench.dao.TranHistoryDao;
import com.dude.crm.workbench.domain.Customer;
...
public class TranServiceImpl implements TranService {
    ...
    public boolean save(Tran t, String customerName) {
        ...
        *       如果没有这个客户则在客户表新建一条客户信息，然后将新建的客户信息id取出，封装到t对象中
        *
